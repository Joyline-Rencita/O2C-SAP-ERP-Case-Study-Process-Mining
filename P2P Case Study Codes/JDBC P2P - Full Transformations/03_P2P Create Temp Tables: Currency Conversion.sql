-- Query No: 1
DROP TABLE IF EXISTS P2P_TCURF_CC;
-- Query No: 2
DROP TABLE IF EXISTS P2P_TCURF_TMP;

-- Query No: 3
CREATE TABLE P2P_TCURF_TMP AS(
	SELECT 
    *
...
SELECT ANALYZE_STATISTICS ('P2P_TCURF_TMP');
-- Query No: 4
CREATE TABLE P2P_TCURF_CC AS(
SELECT 
	*
FROM 
	P2P_TCURF_TMP);
...
-- Query No: 1
DROP TABLE IF EXISTS P2P_TCURR_CC;
-- Query No: 2
DROP TABLE IF EXISTS P2P_TCURR_TMP;

-- Query No: 3
CREATE TABLE P2P_TCURR_TMP AS(
SELECT 
    TCURR.MANDT
    ,TCURR.KURST
    ,TCURR.FCURR
...
SELECT ANALYZE_STATISTICS ('P2P_TCURR_TMP');
-- Query No: 4
CREATE TABLE P2P_TCURR_CC AS(
SELECT 
	* 
FROM 
	P2P_TCURR_TMP
...
SELECT ANALYZE_STATISTICS ('P2P_TCURR_CC');
SELECT ANALYZE_STATISTICS ('P2P_TCURF_CC');

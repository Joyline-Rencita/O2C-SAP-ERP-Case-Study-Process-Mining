INSERT INTO _CEL_P2P_EKBE_ACTIVITIES_DELTA(
    _CASE_KEY
    ,MANDT
	  ,EBELN
	  ,EBELP
...
DELETE FROM
    _CEL_P2P_EKBE_ACTIVITIES_DELTA
WHERE
    EVENTTIME IS NULL;
...
-- Statistics
SELECT ANALYZE_STATISTICS('_CEL_P2P_EKBE_ACTIVITIES_DELTA');
...
INSERT INTO _CEL_P2P_EKBE_ACTIVITIES_DELTA
SELECT *
FROM _CEL_P2P_EKBE_ACTIVITIES_DELTA AS NEW_ACTIVITIES
 WHERE NOT EXISTS (
                    SELECT 1 FROM _CEL_P2P_EKBE_ACTIVITIES_DELTA AS OLD_ACTIVITIES

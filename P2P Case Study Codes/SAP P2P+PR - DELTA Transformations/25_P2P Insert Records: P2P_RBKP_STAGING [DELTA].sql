DELETE FROM P2P_RBKP_STAGING
WHERE EXISTS (SELECT 1 FROM <$RBKP> as NEW_DATA 
              WHERE P2P_RBKP_STAGING.MANDT=NEW_DATA.MANDT 
              AND P2P_RBKP_STAGING.BELNR=NEW_DATA.BELNR 
                AND P2P_RBKP_STAGING.GJAHR=NEW_DATA.GJAHR);

INSERT INTO P2P_RBKP_STAGING 
SELECT DISTINCT 
	RBKP.MANDT,
    RBKP.BELNR,
    RBKP.GJAHR,
